  ...
  return (
    <section id="projects" className="w-full max-w-[1580px] mx-auto px-4 sm:px-8 md:px-12 py-16 scroll-mt-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 pb-4 border-b border-white/[0.08]">
        <div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight">
            Projects <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-300">& Architecture</span>
          </h2>
        </div>
      ...
      <div className="space-y-8">
        {/* Flagship: CoalDarpan */}
        <div className="glass-bento rounded-3xl p-6 sm:p-9 relative overflow-hidden border border-emerald-500/30 hover:border-emerald-500/60 shadow-[0_25px_60px_rgba(0,0,0,0.8),0_0_40px_rgba(16,185,129,0.15)] group transition-all duration-300">
          {/* Ambient Glow */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-emerald-600/20 via-teal-600/10 to-transparent rounded-full blur-3xl pointer-events-none"></div>

          <div className="relative z-10 space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex flex-wrap items-center gap-3">
                <span className="text-2xl">🏛️</span>
                <h3 className="text-2xl sm:text-3xl font-black text-white group-hover:text-emerald-300 transition-colors tracking-tight">
                  CoalDarpan
                </h3>
                <span className="px-3 py-1 rounded-full bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 text-[11px] font-mono-code font-bold uppercase tracking-wider shadow-[0_0_12px_rgba(16,185,129,0.3)]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 py-2">
              <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/[0.06] text-center group-hover:border-emerald-500/20 transition-all">
                <div className="text-emerald-300 font-black text-xl">Gemini 1.5</div>
                <div className="text-[10px] text-white/40 font-mono-code uppercase mt-0.5">AI Vision Engine</div>
              </div>
              <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/[0.06] text-center group-hover:border-emerald-500/20 transition-all">
                <div className="text-teal-400 font-black text-xl">&lt; 50ms</div>
              ...
              <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/[0.06] text-center group-hover:border-emerald-500/20 transition-all">
                <div className="text-cyan-400 font-black text-xl">Offline PWA</div>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-white/[0.08]">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-7 py-3 rounded-xl bg-white text-black font-black text-xs tracking-wider uppercase hover:bg-emerald-400 hover:text-black transition-all shadow-[0_10px_25px_rgba(255,255,255,0.15)] flex items-center gap-2"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-6 py-3 rounded-xl bg-white/[0.05] border border-white/10 hover:border-emerald-500/40 text-white font-mono-code font-bold text-xs tracking-wider uppercase transition-all flex items-center gap-2"
              >
        ...
        <div className="glass-bento rounded-3xl p-6 sm:p-9 relative overflow-hidden border border-white/[0.08] hover:border-emerald-500/40 shadow-[0_20px_50px_rgba(0,0,0,0.7)] group transition-all duration-300">
          <div className="space-y-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex flex-wrap items-center gap-3">
                <span className="text-2xl">🎙️</span>
                <h3 className="text-2xl font-bold text-white group-hover:text-emerald-300 transition-colors tracking-tight">
                  AI Interview Agent
                </h3>
                <span className="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-300 border border-emerald-500/20 text-[10px] font-mono-code font-bold uppercase tracking-wider">
                  MULTIMODAL AI TOOL
                </span>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-3 border-t border-white/[0.06]">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-6 py-2.5 rounded-xl bg-white/[0.06] border border-white/10 hover:border-emerald-500/40 text-white font-mono-code font-bold text-xs tracking-wider uppercase transition-all flex items-center gap-2"
              >
