      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 pb-4 border-b border-white/[0.08]">
        <div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight">
            Projects <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F5A623] via-[#FFC15E] to-amber-200">& Architecture</span>
          </h2>
        </div>
        ...
        <div className="glass-bento rounded-3xl p-6 sm:p-9 relative overflow-hidden border border-white/[0.08] hover:border-[#F5A623]/40 shadow-[0_20px_50px_rgba(0,0,0,0.7)] group transition-all duration-300">
          <div className="space-y-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex flex-wrap items-center gap-3">
                <span className="text-2xl">🎙️</span>
                <h3 className="text-2xl font-bold text-white group-hover:text-[#FFC15E] transition-colors tracking-tight">
                  AI Interview Agent
                </h3>
