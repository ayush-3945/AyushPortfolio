export const portfolioData = {
  personal: {
    ...
    tagline: "I specialize in architecting autonomous AI incident engines and real-time distributed web systems, while building interactive frontends. My focus is on creating end-to-end digital experiences that are robust, performant, and completely timeless.",
