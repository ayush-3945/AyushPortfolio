...
export default function MacDock({ openWindows = [], activeSection = 'hero', onToggleWindow, onScrollTo, onOpenSearch }) {
  ...
  return (
    <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 max-w-[95vw]">
      <div className="px-4 py-2.5 rounded-2xl bg-[#080b11]/90 backdrop-blur-2xl border border-white/[0.1] shadow-[0_20px_50px_rgba(0,0,0,0.9),0_0_20px_rgba(168,85,247,0.08)] flex items-center gap-2 sm:gap-3">
