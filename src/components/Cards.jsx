...
export function StatusCard({ onContactClick }) {
  return (
    <div
      ...
      className="glass-bento rounded-2xl p-5 cursor-pointer group flex flex-col justify-between hover:border-purple-500/40"
    >
      {/* Top Handle Indicator */}
      ...
      <div className="flex items-center gap-2 text-xs font-mono-code text-white/50 mb-2">
        ...
        <span className="uppercase text-[10px] tracking-wider text-purple-400 font-bold">STATUS</span>
      </div>

      <div className="my-1">
        <h4 className="text-white font-semibold text-sm tracking-tight group-hover:text-purple-300 transition-colors">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between text-xs mb-2">
        ...
        <span className="text-[10px] font-mono-code text-purple-400 group-hover:text-purple-300 transition-colors font-bold">VIEW ALL ↗</span>
      </div>

      <div className="my-1">
        <h4 className="text-white font-bold text-sm tracking-tight group-hover:text-purple-400 transition-colors leading-snug">
          {article.title}
        </h4>
      ...
      <div className="flex items-center justify-between text-xs mt-3 pt-2 border-t border-white/[0.06] text-white/40 font-mono-code">
        ...
        <span className="text-purple-400 group-hover:text-purple-300 group-hover:translate-x-1 transition-all font-bold text-[11px]">READ ↗</span>
      </div>
    </div>
  );
}
