  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-xs font-mono-code text-white/50 mb-2">
        ...
        <span className="uppercase text-[10px] tracking-wider text-emerald-400">STATUS</span>
      </div>

      <div className="my-1">
        <h4 className="text-white font-semibold text-sm tracking-tight group-hover:text-emerald-400 transition-colors">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between text-xs mb-2">
        ...
        <span className="text-[10px] font-mono-code text-white/40 group-hover:text-white transition-colors">VIEW ALL ↗</span>
      </div>
      ...
      <div className="flex items-center justify-between text-xs mt-3 pt-2 border-t border-white/[0.06] text-white/40 font-mono-code">
        ...
        <span className="text-white/80 group-hover:text-[#38bdf8] group-hover:translate-x-1 transition-all font-bold text-[11px]">READ ↗</span>
      </div>
    </div>
  );
}
